                        ...
                        <div class="form-group">
                            ...
                            <div class="icheck-primary mt-3">
                                <input type="checkbox" id="current_job_{{$key}}" value="1"
                                    name="workHistories[{{$key}}][current_job]" @if ($item->current_job ?? false) checked
                                @endif>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Position<span class="text-red ml-2">*</span></label>
                    <input type="text" class="form-control" name="workHistories[{{ $index }}][position]" value="">
                    <span class="text-danger workHistories {{$index}} position-error error-message"></span>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label>From</label>
                    <input type="date" name="workHistories[{{ $index }}][from_date]" class="form-control" value="">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label>To</label>
                    <input type="date" class="form-control" name="workHistories[{{ $index }}][to_date]" value="">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label></label>
                    <div class="icheck-primary mt-3">
                        <input type="checkbox" id="current_job_{{$index}}" value="1" name="workHistories[{{ $index }}][current_job]">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Descriptions</label>
                    <textarea name="workHistories[{{ $index }}][description]" id="description" class="form-control summernote_edit"
                        cols="30" rows="10">
                    </textarea>
                </div>
            </div>
