                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Language<span class="text-red ml-2">*</span></label>
                    ...
                    <div class="col-md-8">
                        <div class="form-group clearfix">
                            <label>Proficiency<span class="text-red ml-2">*</span></label>
                            <div style="display: block; padding: .375rem 0;">
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="beginner-{{ $key }}" name="languages[{{ $key }}][proficiency]"
                                        value="0" @if ($language->proficiency == 0) checked @endif>
                                    <label for="beginner-{{ $key }}" class="text-yellow">Beginner</label>
                                </div>

                                <div class="icheck-primary d-inline ml-2">
                                    <input type="radio" id="intermediate-{{ $key }}" name="languages[{{ $key }}][proficiency]"
                                        value="1" @if ($language->proficiency == 1) checked @endif>
                                    <label for="intermediate-{{ $key }}" class="text-orange">Intermediate</label>
                                </div>

                                <div class="icheck-primary d-inline ml-2">
                                    <input type="radio" id="advanced-{{ $key }}" name="languages[{{ $key }}][proficiency]"
                                        value="2" @if ($language->proficiency == 2) checked @endif>
                                    <label for="advanced-{{ $key }}" class="text-red-500">Advanced</label>
                                </div>

                                <div class="icheck-primary d-inline ml-2">
                                    <input type="radio" id="native-{{ $key }}" name="languages[{{ $key }}][proficiency]"
                                        value="3" @if ($language->proficiency == 3) checked @endif>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group clearfix">
                    ...
                    <div style="display: block; padding: .375rem 0;">
                        <div class="icheck-primary d-inline">
                            <input type="radio" id="beginner-{{ $index }}" name="languages[{{ $index }}][proficiency]"
                                value="0" checked>
                        ...
                        <div class="icheck-primary d-inline ml-2">
                            <input type="radio" id="advanced-{{ $index }}" name="languages[{{ $index }}][proficiency]"
                                value="2">
                            <label for="advanced-{{ $index }}" class="text-red-500">Advanced</label>
                        </div>

                        <div class="icheck-primary d-inline ml-2">
                            <input type="radio" id="native-{{ $index }}" name="languages[{{ $index }}][proficiency]"
                                value="3">
