        ...
        <form class="" method="get" action="">
            <div class="container-fluid">
                ...
                <div id="advanced_search" class="collapse mt-2">
                    <input type="hidden" name="isAdvanced" value="{{ $request->isAdvanced ?? 0 }}">
                    <div class="row">
                        <div class="col-sm-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            function checkSearchAdvanced(){
                var isAdvanced = $('input[name="isAdvanced"]').val();
                if(isAdvanced == 1){
                    console.log(isAdvanced);
                    $('#btn-show-advanced-search').css('display', 'none');
                    $('span#delete_advanced_search').css('display', 'unset');
                    $('#advanced_search').addClass('show');
                }
            }
            checkSearchAdvanced();
